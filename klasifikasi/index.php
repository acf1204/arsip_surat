                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="../klasifikasi/index.php">Klasifikasi</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Daftar Klasifikasi</h1>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($klasifikasi as $klasifikasi) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="update.php?id_klasifikasi=<?= $klasifikasi['id_klasifikasi']; ?>" class="btn btn-warning" style="color: white;">Edit</a>
                                                <a href="delete.php?id_klasifikasi=<?= $klasifikasi['id_klasifikasi']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data ini?')" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php $i++;
                                    endforeach; ?>
                        ...
                        <form method="POST">
                            <div class="modal-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputjabatan" name="jabatan" required>
                                </div>
                            </div>
