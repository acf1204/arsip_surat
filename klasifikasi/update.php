...
$klasifikasi = query("SELECT * FROM klasifikasi WHERE id_klasifikasi = $id_klasifikasi")[0];
?>
                            ...
                            <form method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleInputjabatan" name="jabatan" value="<?= $klasifikasi['jabatan'] ?>" required>
                                    </div>
                                </div>
