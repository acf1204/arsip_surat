                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="../keluar/index.php">Surat Keluar</a>
                        </div>
                    </div>
                </li>
            <?php endif; ?>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="tahun" value="<?= $surat['bulan'] ?>">
                                    <input type="hidden" name="fileLama" value="<?= $surat['file'] ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="exampleInputrole" name="no_agenda" value="<?= $surat['no_agenda'] ?>" readonly>
                                                    </div>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="exampleInputrole" name="no_surat" value="<?= $surat['no_surat'] ?>" readonly>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Isi Ringkasan</label>
                                                        <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="isi_ringkasan" readonly><?= $surat['isi_ringkasan'] ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="exampleInputrole" name="tanggal_surat" value="<?= $surat['tanggal_surat'] ?>" readonly>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Tanggal Terima</label>
                                                        <input type="date" class="form-control" id="exampleInputrole" name="tanggal_terima" value="<?= $surat['tanggal_terima'] ?>" readonly>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Keterangan</label>
                                                        <input type="text" class="form-control" id="exampleInputrole" name="keterangan" value="<?= $surat['keterangan'] ?>" readonly>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label for="formFile" class="form-label">File * <a href="../upload/<?= $surat['file'] ?>">DOWNLOAD FILE</a> </label>
                                                        <input class="form-control" type="text" id="formFile" name="file" value="<?= $surat['file'] ?>" readonly>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="modal-footer">
                                        <a href="index.php" type="submit" name="submit" class="btn btn-success">Kembali</a>
                                        <a href="update.php?id_surat=<?= $id_surat ?>" type="submit" name="submit" class="btn btn-primary">Update</a>
                                    </div>
                                </form>
                            </div>
                        </div>
