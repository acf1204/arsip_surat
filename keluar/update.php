                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" id="exampleInputrole" name="no_agenda" value="<?= $surat['no_agenda'] ?>" required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Pengirim</label>
                                                        <input type="text" class="form-control" id="exampleInputrole" name="pengirim" value="<?= $surat['pengirim'] ?>" required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">No.Surat</label>
                                                        <input type="text" class="form-control" id="exampleInputrole" name="no_surat" value="<?= $surat['no_surat'] ?>" required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Isi Ringkasan</label>
                                                        <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="isi_ringkasan" required><?= $surat['isi_ringkasan'] ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="exampleInputrole" name="tanggal_surat" value="<?= $surat['tanggal_surat'] ?>" required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Tanggal Terima</label>
                                                        <input type="date" class="form-control" id="exampleInputrole" name="tanggal_terima" value="<?= $surat['tanggal_terima'] ?>" required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Keterangan</label>
                                                        <input type="text" class="form-control" id="exampleInputrole" name="keterangan" value="<?= $surat['keterangan'] ?>" required>
                                                    </div>
