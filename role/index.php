                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item active" href="../role/index.php">Role</a>
                                ...
                                <tbody>
                                    ...
                                    foreach ($role as $role) : ?>
                                        <tr>
                                            ...
                                            <td><?= $role['role'] ?></td>
                                            <td>
                                                <a href="update.php?id_role=<?= $role['id_role']; ?>" class="btn btn-warning" style="color: white;">Edit</a>
                                                <a href="delete.php?id_role=<?= $role['id_role']; ?>" onclick="return confirm('Anda Yakin Ingin Menghapus Data ini?')" class="btn btn-danger">Hapus</a>
                                            </td>
                                        </tr>
                                    <?php $i++;
                                    endforeach; ?>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambahkan Role</h5>
                        </div>
                        <form method="POST">
                            <div class="modal-body">
                                <div class="mb-3">
                                    <label class="form-label">Role</label>
                                    <input type="text" class="form-control" id="exampleInputrole" name="role" required>
                                </div>
                            </div>
