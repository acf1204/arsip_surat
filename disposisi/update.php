                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            ...
                            <button type="button" class="btn btn-secondary"><a href="index.php?id_surat=<?= $id_surat ?>" style="text-decoration: none; color: white;"> Kembali </a></button>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form action="" method="post">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <select id="disabledSelect" class="form-control" name="id_users">
                                                            <option value="<?= $disposisi['id_users'] ?>"><?= $disposisi['nama_lengkap'] ?></option>
                                                            <?php foreach ($users as $users) : ?>
                                                                <?php if ($users['id_users'] !=  $disposisi['id_users']) : ?>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea class="form-control" id="floatingTextarea2" style="height: 100px" name="isi"><?= $disposisi['isi'] ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="exampleInputrole" name="batas_waktu" value="<?= $disposisi['batas_waktu'] ?>" required>
                                                    </div>

                                                    <div class="mb-3">
                                                        <label class="form-label">Catatan</label>
                                                        <textarea class="form-control" id="floatingTextarea2" style="height: 100px" name="catatan" required><?= $disposisi['catatan'] ?></textarea>
                                                    </div>
                                    ...
                                    <div class="modal-footer">
                                        <a href="index.php?id_surat=<?= $id_surat ?>" class="btn btn-info" data-dismiss="modal">Kembali</a>
