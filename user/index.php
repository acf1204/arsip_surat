...
$users = query("SELECT * FROM users WHERE id_users= $id_users")[0]; ?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card text-center" style="width: 18rem;">
                        <img src="../upload/<?= $users['foto'] ?>" class="card-img-top">
                        <div class="card-body">
                            <h5 class="card-title"><?= $users['nama_lengkap'] ?></h5>
                            <p class="card-text"><?= $users['email'] ?></p>
                            <a href="update.php?id_users=<?= $users['id_users'] ?>" class="btn btn-primary">Ubah Profile</a>
                        </div>
                    </div>
                </div>
                <!-- /.container-fluid -->
